        ...
        <form id="add-form" method="post">
            <table cellpadding="5">
                ...
                <tr>
                    <td>新闻封面:</td>
                    <td>
                        <input class="wu-text easyui-textbox easyui-validatebox" type="text" id="add-photo" name="photo" readonly="readonly" value="/home/huxudong/NewsSSM/SSM-NewsSystem/web/resource/icon/news-pic.jpg" data-options="required:true,missingMessage:'请上传封面'"></input>
...
<div id="preview-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:330px; padding:10px;">
    <table>
        <tr>
            <td><img id="preview-photo" src="/home/huxudong/NewsSSM/SSM-NewsSystem/web/resource/icon/news-pic.jpg" width="300px"></td>
        </tr>
    </table>
</div>
<!-- 上传图片进度条 -->
